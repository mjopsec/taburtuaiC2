...
type TimeGate struct {
	WorkStart int    // hour (0-23), -1 = disabled
	WorkEnd   int    // hour (0-23), -1 = disabled
	KillDate  string // RFC3339 or YYYY-MM-DD, empty = disabled
}
...
// Returns an error if the kill date has passed (agent should exit).
